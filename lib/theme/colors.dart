...
class DarkThemeColors {
  static Color taskDoneTickShade = const Color(0xFF3D47AF);
  static Color backgroundColor = const Color(0xFF111B21);
  static Color headlineFontColor = const Color(0xFFF4F6FD);
  static Color captionAndIconFontColor = const Color(0xFFBBC2D8);
  static Color sideMenuBackgroundColor = const Color(0xFF0A155A);
  static Color primaryButtonColor = const Color(0xFF2643C4);
  static Color primaryAccentColor = const Color(0xFFA056C5);
